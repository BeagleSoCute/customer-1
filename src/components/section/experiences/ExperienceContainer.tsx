    ...
    <SectionContainerHOC>
      <div className="flex">
        ...
        <div className="col-span-4 w-[40%] ">
          <h1 className="text-[60px] blue-text font-bold">
            10 Years <span className="block"> Experience</span>{" "}
          </h1>
          <div className="text-[20px] text-[#525B7A]">
          ...
          <div className="flex justify-end">
            <button className="button-global-style md:mt-[41px] mt-[5px] bg-white text-black blue-btn ">
              Join With Us
            </button>
          </div>
        </div>
